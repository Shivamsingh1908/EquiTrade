...
const FAQs = () => {
  const faqData = [
    {
      question: "What is EquiTrade?",
      answer:
        "EquiTrade is a leading stock brokerage firm in India that offers a platform for trading in stocks, commodities, and currencies.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "EquiTrade charges a flat fee of ₹20 per trade for equity and commodity trading, and there are no brokerage fees for delivery trades.",
    },
    {
      question: "Is there a mobile app?",
      answer:
        "Yes, EquiTrade offers a mobile app called Kite, which allows you to trade on the go.",
    },
    {
